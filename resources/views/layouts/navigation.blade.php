<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->role === 'manager')
                        <x-nav-link :href="route('projects.approval-queue')" :active="request()->routeIs('projects.approval-queue')">
                            {{ __('Approval Queue') }}
                        </x-nav-link>
                    @endif
                    ...
                    @elseif(Auth::user()->role === 'sales')
                        ...
                        <x-nav-link :href="route('leads.create')" :active="request()->routeIs('leads.create')" class="bg-blue-600 hover:bg-blue-700 rounded-md" style="color: #000000 !important;">
                            {{ __('+ Add Lead') }}
                        </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->role === 'manager')
                <x-responsive-nav-link :href="route('projects.approval-queue')" :active="request()->routeIs('projects.approval-queue')">
                    {{ __('Approval Queue') }}
                </x-responsive-nav-link>
            @endif
            ...
            @elseif(Auth::user()->role === 'sales')
                ...
                <x-responsive-nav-link :href="route('leads.create')" :active="request()->routeIs('leads.create')" style="color: #000000 !important;">
                    {{ __('+ Add New Lead') }}
                </x-responsive-nav-link>
            @endif
        </div>
